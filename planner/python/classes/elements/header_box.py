...
class Prompt(svgwrite.container.Group):
  """
  Container for prompt and entry lines.
  """
...
class HeaderBox(svgwrite.container.Group):
  ...
  def create_header(self):
    ...
    header_box_hght: int = self.font_size_ + 2 * Font.TEXT_PADDING
    ...
    header_box: svgwrite.shapes.Rect =\
      ...
      ( size=(self.wdth_, header_box_hght)
      , insert=(0,0)
    ...
    insert_txt_y: int = header_box_hght - Font.TEXT_PADDING
